...
# am i done now???
touch "/home/$user_m/$pfile/remove-user-reinstall.sh"

printf '#!/bin/bash\n' | tee -a "/home/$user_m/$pfile/remove-user-reinstall.sh"
printf "\n" | tee -a "/home/$user_m/$pfile/remove-user-reinstall.sh"
...
sudo chmod 755 "/home/$user_m/$pfile/remove-user-reinstall.sh" 
sudo chmod +x "/home/$user_m/$pfile/remove-user-reinstall.sh" 

/home/$user_m/$pfile/remove-user-reinstall.sh
rm -f "/home/$user_m/$pfile/remove-user-reinstall.sh"
exit 0